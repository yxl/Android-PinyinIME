...
emcc ../share/pinyinime.cpp ../share/dictbuilder.cpp ../share/dicttrie.cpp \
     ...
     ../share/utf16reader.cpp -O2 --closure 0 -g3 -o libpinyin.js -s LINKABLE=1 \
     ...
     '_im_search', '_im_delsearch', '_im_reset_search', '_im_get_sps_str', '_im_get_candidate', \
     '_im_get_spl_start_pos', '_im_choose', '_im_cancel_last_choice', '_im_get_fixed_len', \
     '_im_get_predicts', '_im_enable_shm_as_szm', '_im_enable_ym_as_szm', '_malloc']"
